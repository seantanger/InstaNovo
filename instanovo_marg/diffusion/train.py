...
from instanovo_marg.diffusion.multinomial_diffusion import (
    DiffusionLoss,
    InstaNovoPlus,
...
from instanovo_marg.transformer.dataset import (
    SpectrumDataset,
    collate_batch,
    remove_modifications,
)
from instanovo_marg.transformer.train import (
...
from instanovo_marg.utils.metrics import Metrics
...
def train(config: DictConfig) -> None:
    ...
    logger.info(f"Training instanovo_marg+ on device: {device}")
    ...
    # Initialize decoder
    decoder = DiffusionDecoder(model=model, sdf=train_sdf)
